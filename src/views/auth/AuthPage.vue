<template>
  ...
  >
    ...
    <w-dialog width="500px"
        v-model="showDialog"
        >
      <div class="pa5 title3">
        Ви студетн?
      </div>

      <w-flex class="pt10">
        <w-button class="grow mr5" @click="yes">Так</w-button>
        <w-button class="grow mr5" @click="no">НІ</w-button>
      </w-flex>
      </w-dialog>
  </w-app>
</template>
